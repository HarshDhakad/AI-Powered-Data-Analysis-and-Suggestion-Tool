...
if not HUGGINGFACEHUB_API_TOKEN:
    raise ValueError("❌ Hugging Face API token not found. Please set it in .streamlit/secrets.toml or .env file.")
...
Based on the dataset summary and the prediction summary and problem statement, generate 2-3 actionable profitable business recommendations to help resolve the problem described above.""",
