...
def select_model(problem_statement):
    """Selects appropriate ML model and task type based on problem statement."""
    ...
    # Detect from predefined mapping
    for keyword, task in problem_to_task.items():
        if keyword in problem_statement_lower:
            task_type = task
            break
